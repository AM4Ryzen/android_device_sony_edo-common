...
# Bluetooth (AOSP stack has no sound on 17.1)
PRODUCT_PACKAGES += \
    BluetoothQti
...
# Fstab (vendor.ipacm process causes a bootloop with this currently. See if it works with custom built vendor later.)
#PRODUCT_COPY_FILES += \
